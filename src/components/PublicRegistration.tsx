    ...
    return (
      <div className="flex flex-col items-center space-y-4">
        ...
        >
          ...
          {/* 5. QR Code for the specific athlete */}
          <div className="flex flex-col items-center justify-center bg-white border border-red-500 dark:border-red-600 rounded-2xl p-1.5 max-w-[125px] mx-auto shadow-xs z-10">
            <img 
              src={qrUrl} 
            ...
            />
            <span className="text-[7px] text-red-650 font-mono font-bold tracking-wider mt-0.5 uppercase block text-center">
              QUÉT GHI ĐIỂM
            </span>
          </div>
